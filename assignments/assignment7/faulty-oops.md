...
This means the crash occurred 16 bytes into faulty_write, whose total size is 0x20 bytes. The invalid access is therefore very early in faulty_write and corresponds to the instruction shown in the “Code:” line.
